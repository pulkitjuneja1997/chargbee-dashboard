...
Codebase.onLoad(
    class {
        static initDashboardChartJS() {
            ...
            let e,a, t = document.getElementById("js-chartjs-dashboard-lines"), r = document.getElementById("js-chartjs-dashboard-lines2");
            null !== t && (
                e = new Chart( t, {
                    type: "line",
                    data: {
        ...
        static init() { this.initDashboardChartJS() }
    }.init());
