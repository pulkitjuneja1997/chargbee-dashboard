      ...
      <div class="row g-6 w-100 py-7 overflow-hidden">
        ...
        <div class="col-md-5 py-4 d-flex align-items-center">
          <div class="text-center text-md-start">
            ...
            <a class="btn btn-alt-primary py-3 px-4" href="be_pages_dashboard.php" target="_blank">
  ...
  <div class="content content-full">
    <div class="pt-7 pb-5">
      ...
      <div class="text-center">
        <a class="btn btn-alt-secondary" href="be_pages_dashboard4.php" target="_blank">
  ...
  <div class="position-relative">
    <div class="content content-full">
      <div class="pt-7 pb-5">
        ...
        <div class="text-center">
          <a class="btn btn-alt-secondary" href="be_pages_generic_todo.php" target="_blank">
      ...
      <div class="pt-7 pb-5">
        ...
        <div class="row g-4 py-2">
          ...
          <div class="col-md-4 py-3 text-center text-md-start">
            ...
            <a class="btn btn-sm btn-alt-primary" href="be_pages_dashboard.php" target="_blank">
